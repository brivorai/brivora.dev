---
title: Quickstart
description: Generate and verify a governance proof in under 5 minutes.
---
...
## Wrap an AI call with governance
...
The proof is a PQC-signed Merkle root. It can be stored, transmitted, published on-chain, or handed to a regulator. Anyone can verify it without trusting you, Brivora, or any intermediary.
